...
const LoginPage = () => {
  ...
  return (
    <div className='flex w-full  h-[100vh]'>
      ...
      <div className='flex w-full md:w-2/3 h-full bg-white dark:bg-gradient-to-b md:dark:bg-gradient-to-r from-black via-[#00073f] to-black items-center px-10 md:px-20 lg:px-40'>
          ...
          <div className='max-w-md w-full space-y-8'>
            ...
            <form className='mt-8 space-y-6' onSubmit={handleSubmit}>
              <div className='flex flex-col rounded-md shadow-sm -space-y-px gap-5'>
                ...
                <Button
                  label='Sign In'
                  type='submit'
                  styles='group relative w-full flex justify-center py-2.5 2xl:py-3 px-4 border border-transparent text-sm font-medium rounded-full text-white bg-black dark:bg-violet-500 hover:bg-violet-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rose-500 mt-8'
                />
              </div>
            </form>
            <div className='flex items-center justify-center text-gray-600 dark:text-gray-300'>
              <p>
                ...
                <Link to='/sign-up' className='text-violet-500 font-medium'>
                  Sign up
                </Link>
              </p>
            </div>
